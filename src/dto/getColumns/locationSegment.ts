...
import { LocationKinds, LocationKindsColors } from '../../dal/enums/locationKinds';
    ...
    getColumns: (...pre: string[]): DefinedMRTColumns<ILocationSegment> =>
        (
            [
                ...
                $metas.enum('kind', { enumMap: LocationKinds, colorMap: LocationKindsColors, header: 'Location Kind' }, false),
