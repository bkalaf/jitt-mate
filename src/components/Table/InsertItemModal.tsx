...
export function InsertItemModal<T extends FieldValues & EntityBase>({
    ...
    EditControls: React.FunctionComponent<Parameters<Exclude<MRT_ColumnDef<any, any>['Edit'], undefined>>[0]>;
    init: () => Promise<T>;
    list: T[];
    open: boolean;
    toggleOpen: () => void;
    ...
    function InnerInsertItemModal(props: Parameters<Exclude<MRT_ColumnDef<any, DBList<T>>['Edit'], undefined>>[0]) {
