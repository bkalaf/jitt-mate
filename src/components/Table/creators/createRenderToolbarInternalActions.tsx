...
import { faBoltLightning, faDumpsterFire, faFilterSlash, faFilters, faMagnifyingGlass, faMagnifyingGlassMinus, faRedoAlt, faSquarePlus } from '@fortawesome/pro-solid-svg-icons';
