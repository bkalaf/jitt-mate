...
export function enumDefinition<T extends MRT_RowData>(name: Path<T>, { enumMap, colorMap, ...opts }: { enumMap: EnumMap, colorMap?: EnumMap; header?: string }, initialDisable = false, ...dependencies: IDependency[]) {
