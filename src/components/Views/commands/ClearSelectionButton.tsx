...
export function ClearSelectionButton<T extends EntityBase>({ table }: { table: Table<T>; }) {
    ...
    return <Button icon={faTimesCircle} onClick={clearSelection} renderCondition={true} disabledCondition={!enabled()} className='w-6 h-6 bg-transparent border border-sky-500 text-rose-700' />;
}
