...
export function AddRelationshipButton<T extends EntityBase>({ listType, listOf, property, row,original }: { listType: string; listOf: string; property: string; original: RealmCollections<T>; row: Row<T> }) {
