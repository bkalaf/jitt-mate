...
export function usePropertyInfo<T>(table: Table<T>, column: Column<T, any> | ColumnDef<T, any>, expectedType: RealmTypes) {
    ...
    const { datatype, defaultValue: defaultValue2, enumMap, lookupProperty, labelProperty, readonly, required: req2, validators, objectType: ot, inputType, colorMap, valuesGetter } = useColumnMeta(column);
