...
export const getSizeName = tap<[SizeKeys | undefined], ISizeEntry | undefined, string | undefined>(
    (x?: any) => undefined,
    (x?: ISizeEntry) => x?.name
);
export const getSizeSelector = tap<[SizeKeys | undefined], ISizeEntry | undefined, string | undefined>(
    (x?: any) => undefined,
    (x?: ISizeEntry) => x?.selector
);
export const getSizeKey = tap<[SizeKeys | undefined], ISizeEntry | undefined, string | undefined>(
    (x?: any) => undefined,
    (x?: ISizeEntry) => x?.key
);
