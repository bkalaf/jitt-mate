...
module.exports = {
    ...
    theme: {
        data: {
            ...
            'is-bool': 'datatype="bool"',
            'is-numeric': 'datatype="numeric"',
            'is-enum': 'datatype="enum"',
            'is-embed': 'datatype="embed"',
            'is-datetime': 'input-type="datetime-local"',
            'is-date': 'input-type="date"',
            'is-backlink': 'datatype="linkingObjects"',
            'is-list': 'datatype="list"',
            'is-dictionary': 'datatype="dictionary"',
    ...
    plugins: [
        plugin(function ({ addBase, addComponents, addUtilities, addVariant }) {
            ...
            addUtilities({
                ...
                '.animate-float-input': {
                    animation: '1.2s 1 linear float-input'
                },
                '.animate-bounce-in-down': {
                    animation: '1.5s 1 normal bounceindown',
                    'animation-fill-mode': 'both'
                },
                '.animate-back-out-up': {
                    animation: '1.5s 1 normal backoutup',
                    'animation-fill-mode': 'both'
                },
                '.animate-bounce-out-up': {
                    animation: '1.5s 1 normal bounceoutup',
                    'animation-fill-mode': 'both'
                },
                '.animate-fade-out-right': {
                    animation: '1.5s 1 normal fadeoutright'
                },
                '.animate-fade-out-left': {
                    animation: '1.5s 1 normal fadeoutleft'
                },
                '.animate-slide-in-down': {
                    animation: '1.5s 1 normal slideindown',
                    'animation-fill-mode': 'both'
                },
                '.animate-slide-out-up': {
                    animation: '1.5s 1 normal slideoutup',
                    'animation-fill-mode': 'both'
                },
                '.animate-slide-out-down': {
                    animation: '1.5s 1 normal slideoutdown',
                    'animation-fill-mode': 'both'
                },
                '.animate-slide-in-up': {
                    animation: '1.5s 1 normal slideinup',
                    'animation-fill-mode': 'both'
                },
                '.animate-pulse-in-center': {
                    animation: '1.5s 1 normal pulseincenter',
                    'animation-fill-mode': 'both'
                },
                '.animate-pulse-out-center': {
                    animation: '1.5s 1 normal pulseoutcenter',
                    'animation-fill-mode': 'both'
                },
                '.disclosureSquare': {
                    listStyle: 'square'
                ...
                //     '--fa-secondary-color': cyan[500],
                //     '--fa-primary-opacity': 1,
                //     '--fa-secondary-opacity': 0.7,
                //     '--fa-border-padding': '0.25rem',
                //     '--fa-border-width': 0,
